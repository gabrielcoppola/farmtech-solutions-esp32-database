...
![Diagrama do sistema](document/images/dados-tabela.png "Criação da Tabela")
...
![Importação - Etapa 1](document/images/import-0.png "Importar Dados")

---

| Etapa | Ação no SQL Developer | Configuração Crucial |
| :--- | :--- | :--- |
| **2. Formato** | O assistente tentará adivinhar o formato. Corrija manualmente. | **Delimitador de Campo:** altere de vírgula (`,`) para **Ponto e Vírgula (`;`)**. |

![Importação - Etapa 2](document/images/import-1.png "Importar Dados")

---

| Etapa | Ação no SQL Developer | Configuração Crucial |
| :--- | :--- | :--- |
| **3. Colunas** | Revise o mapeamento das colunas do arquivo para as colunas da tabela. | **Atenção:** a coluna `ID_REGISTRO` **não deve ser mapeada**, pois é gerada automaticamente pelo Oracle. |

![Importação - Etapa 3](document/images/import-2.png "Importar Dados")
...
| Etapa | Ação no SQL Developer | Configuração Crucial |
| :--- | :--- | :--- |
| **5. Método** | Escolha o método de inserção. | Selecione **"Insert"** para carregar os novos registros na tabela. |

---

| Etapa | Ação no SQL Developer | Configuração Crucial |
| :--- | :--- | :--- |
| **6. Concluir** | Revise o resumo e clique em **"Concluir"** para iniciar a importação. | O assistente deve indicar a inserção de **3000 linhas**. |

![Importação - Etapa 6](document/images/import-3.png "Importar Dados")
...
![Diagrama do sistema](document/images/select-0.png "Select dos Dados")
...
![Diagrama do sistema](document/images/select-1.png "Select dos Dados")
